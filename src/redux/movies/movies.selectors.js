...
export const selectRecentLastAudios = state => state.movies.recentLastAudios;

export const selectRecentLastAudiosSelector = createSelector(
    [selectRecentLastAudios],
    recentLastAudios => recentLastAudios.data
)
